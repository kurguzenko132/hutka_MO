...
export default function FunnelsPage() {
  return (
    <div className="space-y-6">
      <PageHeader title="Воронки" subtitle="Kanban-доска по стадиям привлечения" actionLabel="Добавить лида" />
          ...
          <Card key={stage} className="min-h-[520px] min-w-64">
            ...
            <CardContent className="space-y-3">
              ...
              {leads.filter((lead) => lead.stage === stage).length === 0 && (
                <div className="rounded-2xl border border-dashed border-app-line p-4 text-sm text-app-muted">Пока нет лидов на этой стадии</div>
              )}
            </CardContent>
          </Card>
        ))}
