      ...
      <Card className="border-red-100 bg-gradient-to-br from-white to-red-50/40">
        <CardHeader>
          ...
          <p className="text-sm leading-6 text-app-muted">
            Это действие удаляет контакты, задачи, анкеты, ответы, кампании, инсайты, гипотезы, связи, уведомления и импорт-логи. Используй перед тем, как начинать заполнять настоящую базу.
          </p>
        </CardHeader>
        <CardContent>
