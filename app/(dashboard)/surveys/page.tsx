...
export default async function SurveysPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Анкеты" subtitle="Формы для проверки болей, интереса и готовности к тестированию" actionLabel={can(role, 'manageSurveys') ? 'Создать анкету' : undefined} actionHref={can(role, 'manageSurveys') ? '/surveys/new' : undefined} />
