...
function errorNotice(params: SearchParams): Notice | null {
  ...
  const dictionary: Record<string, Notice> = {
    ...
    'task-save-failed': { tone: 'error', title: 'Задача не сохранена', text: 'Проверь подключение Supabase и поля формы.' },
    'task-assignee-not-found': { tone: 'error', title: 'Участник не найден', text: 'Один из выбранных пользователей приложения больше недоступен.' },
    'task-assignees-failed': { tone: 'error', title: 'Участники не привязаны', text: 'Проверь, что таблица task_assignees создана в Supabase.' },
    'task-status-failed': { tone: 'error', title: 'Статус не обновлен', text: 'Попробуй изменить статус задачи еще раз.' },
    'missing-task': { tone: 'error', title: 'Задача не выбрана', text: 'Не удалось определить задачу для действия.' },
    'task-not-found': { tone: 'error', title: 'Задача не найдена', text: 'Возможно, ее уже удалили или изменилась база.' },
    'task-delete-failed': { tone: 'error', title: 'Задача не удалена', text: 'Попробуй удалить задачу еще раз.' },
